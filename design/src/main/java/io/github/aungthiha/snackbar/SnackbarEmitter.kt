...
fun SnackbarEmitter.showNetworkErrorSnackbar() {
    showSnackBar(
        message = R.string.check_your_internet_connection,
        withDismissAction = true
    )
}

fun SnackbarEmitter.showGeneralErrorSnackbar() {
    showSnackBar(
